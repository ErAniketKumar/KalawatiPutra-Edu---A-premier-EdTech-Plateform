...
// const WelcomeCertificate = require('../models/WelcomeCertificate');
...
// exports.generateWelcomeCertificate = async (req, res) => {
//   try {
...
//     const certificate = new WelcomeCertificate({
//       userId,
//       certificateNumber,
//       issueDate: new Date(),
//     });
...
//       margin: 20,
//       info: {
//         Title: `Welcome Certificate - ${user.name}`,
...
//         'Content-Disposition': `attachment; filename=welcome-certificate-${certificateNumber}.pdf`,
//       });
//       res.send(pdfData);
//     });
...
//     doc.text('WELCOME CERTIFICATE', contentPadding, height / 5, {
//       align: 'center',
